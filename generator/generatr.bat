...
:: .cpp and .h files:
:: cimgui.h and cimgui.cpp with clang preprocess
...
::process  files
:: arg[1] compiler name clang, clang or cl
...
luajit ./generator.lua clang "internal noimstrv" glfw opengl3 opengl2 sdl2 sdl3 -DIMGUI_USE_WCHAR32 %*
